...
class mapa_Santiago : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        mMap.addMarker(
            MarkerOptions().position(point32).title("Av. Las Acacias 184 (El Vergel)").snippet("Vidrio")
                .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN))
        )
        ...
        val point985 = LatLng(-33.45503920, -70.59646100)
        mMap.addMarker(
                MarkerOptions().position(point985).title("HOLANDA / IRARRAZAVAL").snippet("Vidrio")
                        .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN))
        )
